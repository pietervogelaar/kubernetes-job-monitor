...
},{"./ModuleSpec":1,"./internal":4,"./promise":5}],4:[function(require,module,exports){
var promise = require("./promise");
var ModuleSpec = require('./ModuleSpec');
...
},{"./ModuleSpec":1,"./promise":5}],5:[function(require,module,exports){
...
module.exports = require('@jenkins-cd/js-modules').requireModule('core-assets/jquery-detached:jquery2');
},{"@jenkins-cd/js-modules":3}],7:[function(require,module,exports){
var ___$$$___requiredModuleMappings = ["core-assets/jquery-detached:jquery2"];

var ___$$$___jsModules = require('@jenkins-cd/js-modules');

___$$$___jsModules.whoami('try');
...
function ___$$$___doExports() {
    // Do exports, if any ....
    ___$$$___jsModules.exportModule(undefined, 'try', {});
...
function ___$$$___doBundleInit() {
    try {
        ...
        console.error('Error initializing Jenkins JavaScript bundle "try"', e);
    }
}
...
},{"@jenkins-cd/js-modules":3,"jquery-detached":6}]},{},[7]);
